...
urlpatterns = [
    ...
    path("contracts/<uuid:contract_id>/", views.get_contract, name="contract"),
    path(
        "contracts/<uuid:contract_id>/file/<str:file_id>",
        views.get_contract_file,
        name="contract_file",
    ),
    path(
        "contracts/<uuid:contract_id>/archive",
        views.archive_contract,
        name="archive_contract",
    ),
    path(
        "contracts/<uuid:contract_id>/edit", views.edit_contract, name="edit_contract"
    ),
    path(
        "contracts/<uuid:contract_id>/save/",
        views.save_edited_contract,
        name="save_edited_contract",
    ),
    path(
        "contracts/<uuid:contract_id>/analyze",
        views.analyze_contract,
